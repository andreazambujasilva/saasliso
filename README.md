...
```bash
sudo apt install -y git && git clone [https://github.com/ctichat/instaladorvemfazer](https://github.com/andreazambujasilva/saasliso) install && sudo chmod -R 777 ./install && cd ./install && sudo ./install_primaria
```
